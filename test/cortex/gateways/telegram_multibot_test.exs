defmodule Cortex.Gateways.TelegramMultibotTest do
  ...
  setup do
    home = Path.join(System.tmp_dir!(), "cortex_tgmb_#{System.unique_integer([:positive])}")
    File.mkdir_p!(home)
  ...
  test "bot_active? resolves ${ENV_VAR} tokens" do
    var = "CORTEX_TEST_TG_TOKEN_#{System.unique_integer([:positive])}"
