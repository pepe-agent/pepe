defmodule Cortex.Agent.SessionPersistenceTest do
  use ExUnit.Case, async: false

  alias Cortex.Agent.SessionPersistence, as: P

  setup do
    home = Path.join(System.tmp_dir!(), "cortex_sp_#{System.unique_integer([:positive])}")
    File.mkdir_p!(home)
