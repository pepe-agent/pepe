defmodule Pepe.HeartbeatTest do
  use ExUnit.Case, async: false

  alias Pepe.Heartbeat
  alias Pepe.Heartbeat.Cooldown
  ...
  describe "build_prompt/2" do
    ...
    test "includes HEARTBEAT.md content when present" do
      home = Path.join(System.tmp_dir!(), "pepe_hb_#{System.unique_integer([:positive])}")
      File.mkdir_p!(home)
      ...
      dir = Pepe.Agent.Workspace.dir("watcher")
      File.mkdir_p!(dir)
