defmodule CortexWeb.DashData do
  @moduledoc """
  ...
  def bot_active?(bot), do: Cortex.Gateways.Telegram.bot_active?(bot)
  ...
  def cron_history(id), do: Cortex.Cron.Log.tail(id, 3)
  ...
  def provider_options, do: Enum.map(Cortex.Providers.all(), &{&1.key, &1.label})
