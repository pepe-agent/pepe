defmodule Cortex.Docs do
  @moduledoc """
  Bundled how-to documentation the agent reads to learn **how Cortex itself works** —
  ...
  `<CORTEX_HOME>/docs/` (and override a built-in of the same name).
  ...
  defp builtin_dir, do: Application.app_dir(:cortex, "priv/docs")
