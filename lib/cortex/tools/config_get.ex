defmodule Cortex.Tools.ConfigGet do
  @moduledoc "Read the current Cortex configuration (so the agent can answer about it / decide changes)."
  ...
  def spec do
    function(
      "config_get",
      "Read the current Cortex configuration — model connections, agents, the default model/agent, the system-message language, and Telegram status. Use it to answer the user about the setup or before changing something.",
