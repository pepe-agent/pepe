...
export const docsNav: { group: string; slugs: string[] }[] = [
  ...
  { group: "capabilities", slugs: ["skills", "learning", "insight", "routing", "delegation", "admin-agents", "browser", "fetch-url"] },
  {
    group: "channels",
  ...
  { group: "api", slugs: ["api", "sessions", "auth", "usage-api", "websocket", "editors", "clients"] },
