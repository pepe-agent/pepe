---
title: Flows
description: Cuando un agente ya hizo el mismo trabajo de la misma forma unas cuantas veces, conviértelo en un script que repite exactamente los mismos pasos, sin ninguna llamada al modelo.
---
