...
Para restaurar, extrae el archivo de vuelta en `~/` (o en el directorio padre de `PEPE_HOME`) y vuelve a exportar esas variables. Esa es toda la historia de recuperación ante desastres.
