...
Arranca el servidor y luego envía una chat completion. Esto funciona de fábrica sin autenticación (consulta [Autenticación](#autenticación-y-tokens) para cerrarlo con llave):
