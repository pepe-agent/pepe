---
title: Flows
description: Once an agent has done the same job the same way a few times, turn it into a script that replays those exact steps, with no model call at all.
---
