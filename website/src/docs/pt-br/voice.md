...
Manda um áudio no Telegram, no WhatsApp ou no Discord, e o que o agente
recebe é **texto**. A transcrição acontece na chegada, antes mesmo de existir uma
...
- No **WhatsApp**, o que chega é um id de mídia, não o arquivo. O Pepe resolve
  ...
  nenhuma configuração extra. A Meta limita mídia recebida a 16 MB.
