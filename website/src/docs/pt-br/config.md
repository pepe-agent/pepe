...
Para restaurar, extraia o arquivo de volta em `~/` (ou dentro do diretório pai de `PEPE_HOME`) e exporte essas variáveis de novo. Essa é toda a história de recuperação de desastre.
