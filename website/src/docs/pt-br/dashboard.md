...
- **Companies**: criar, editar e excluir escopos de empresa e a margem de cobrança de cada um. Veja [Empresas](../companies/).
...
- **Usage and billing**: uso de tokens e custo por ciclo, por empresa. Veja [Uso e cobrança](../billing/).
